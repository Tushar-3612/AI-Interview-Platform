...
import { mcqQuestions } from "./cognizant_data/mcqs.js";
import { technicalQuestions } from "./cognizant_data/technical.js";
import { codingQuestions } from "./cognizant_data/coding.js";

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const targetDir = path.resolve(__dirname, "../data/companyMock/cognizant");

if (!fs.existsSync(targetDir)) {
  fs.mkdirSync(targetDir, { recursive: true });
}

console.log("=== Generating Cognizant Question Bank ===");
...
console.log("Cognizant question banks written successfully.");
