...
const individualTechnicalResultSchema = new mongoose.Schema(
  {
    userId: {
    ...
    questionResults: [
      {
        ...
        rawMaxScore: { type: Number, default: 5 },
...
const IndividualTechnicalResult = mongoose.model(
  "IndividualTechnicalResult",
  individualTechnicalResultSchema
);

export default IndividualTechnicalResult;
